...
////////////////////////////////////////////////////////////////////////////
/// @brief Test write operation of SerialCom
/// @param SerialComTest is test fixture
/// @param writeSerialPortTest is test name
TEST_F(SerialComTest, writeSerialPortTest)
{
    // const std::vector<uint8_t> data{'h', 'e', 'l', 'o'};
    ...
    // EXPECT_NO_THROW(m_serial.write(data));
