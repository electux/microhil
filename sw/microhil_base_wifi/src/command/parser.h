...
////////////////////////////////////////////////////////////////////////////
/// @brief Fetches and parses a command frame from Wi-Fi TCP or USB-Serial stream
///
/// Accumulates incoming characters from both transports. Returns true and
/// populates `buf` when a complete frame enclosed in '<' and '>' markers is received.
///
/// @param buf [out] Destination buffer to store parsed command string
