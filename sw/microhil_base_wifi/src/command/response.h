...
////////////////////////////////////////////////////////////////////////////
/// @brief Sends a response string over active Wi-Fi TCP client and USB-Serial
/// @param msg [in] Null-terminated response string
void response_send(const char *msg);

////////////////////////////////////////////////////////////////////////////
/// @brief Sends a formatted response string over active Wi-Fi TCP client and USB-Serial
