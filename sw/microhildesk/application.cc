...
namespace
{
	...
	/// @{
	/// @brief Unique application identifier used for GTK bus and registration.
...
/// Initializes the GTK application with the unique ID and sets the global
/// application name for the desktop environment.
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/// Uses Glib::RefPtr for memory-managed instance creation.
/// @return A Glib::RefPtr pointing to the EntryApplication instance.
////////////////////////////////////////////////////////////////////////////////////////////////////////
