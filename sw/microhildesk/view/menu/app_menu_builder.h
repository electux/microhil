...
namespace Electux::App::View::Menu {
    ...
    /// @brief Builds the GIO Menu structure for the main application menubar.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    class AppMenuBuilder : public IAppMenuBuilder {
      public:
        AppMenuBuilder() = default;
        ~AppMenuBuilder() override = default;

        AppMenuBuilder(const AppMenuBuilder &) = delete;
        AppMenuBuilder &operator=(const AppMenuBuilder &) = delete;

        Glib::RefPtr<Gio::Menu> buildMenu() const override;
    };
} // namespace Electux::App::View::Menu
