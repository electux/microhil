...
static const char *const MICROHIL_VERSION = "microHIL-BLE v1.0.0";
static const char *const MICROHIL_BOARD_ID = "mh:333:2023:0:ble";
...
static const command_entry_t command_tbl[] = {
    ...
    {"mh#ble#get#end", ble_command_handle_get},
    {"mh#ble#reset#end", ble_command_handle_reset},
};
...
void command_dispatch(const char *cmd_str) {
  if (strncmp(cmd_str, "mh#ble#set#", 11) == 0) {
    ble_command_handle_set(cmd_str);
    return;
  }
